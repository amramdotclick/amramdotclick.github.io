...
if (userEmail != null) {
  document.getElementById("name").innerHTML = "<h3>"+userEmail+"</h3><br><button class='generalbtn' style='width:100%;' onclick='window.location.href=\"/logout.html\"'>Logout</button>";
} else {
  document.getElementById("name").innerHTML = "<h3>Not logged in</h3><br><button class='generalbtn' style='width:100%;' onclick='window.location.href=\"/login.html\"'>Login</button></span>";
}
